...
async function db_insert(db_name, user, pass, db_host, db_port) {
    ...
    const sequelize = new Sequelize(db_name, user, pass, {dialect: 'mysql', host: db_host, port: db_port});
    try {
    ...
    try {
        ...
        await asignatura.create({id: 805315, nombre: 'Metodos Algoritmicos en Resolución de Problemas I', siglas: 'MAR1', periodo: 1, plan_id: '2019'});
        ...
        await clase.create({ asignatura_id: 805315, grupo_id: 1});
        
        await join_actividad_docentes.create({ docente_id: 3, actividad_id: 1 });
        await join_actividad_docentes.create({ docente_id: 3, actividad_id: 2 });
        await join_actividad_clase.create({ actividad_id: 1, clase_id: 1});
        await join_actividad_clase.create({ actividad_id: 2, clase_id: 1});
        ...
        await join_actividad_espacio.create({ actividad_id: 2, espacio_id: 5 });
