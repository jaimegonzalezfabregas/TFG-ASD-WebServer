...
// Código para generar un QR dinámicamente al llamar a la página
...
if (espacio.length > 1) {
  ...
  toCanvas(document.getElementById('qrcode'), `https://localhost:5500/formulario-end/?espacio=${espacio[1]}`, {
