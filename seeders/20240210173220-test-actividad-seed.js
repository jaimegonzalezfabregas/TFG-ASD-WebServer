  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    return await queryInterface.bulkInsert('Actividad', [
      ...
      {id: 2, fecha_inicio: moment().format('YYYY-MM-DD hh:mm:ss'), tiempo_inicio: '18:00', tiempo_fin: '19:40', es_todo_el_dia: 'No', es_recurrente: 'Sí', creadoPor: 'Galdo', responsable_id: 3}
    ]);
